...
class Category:
  ...
  def add_child(self, category: "Category"):
    if self.id is not None and self.id != '':
      category.id = self.id + "_" + category.id
...
class ProductHeader:
  def __init__(self,
    ...
    self.short_description = short_description if short_description is not None and isinstance(short_description, str) else ''
    self.long_description = long_description if long_description is not None and isinstance(long_description, str) else ''
